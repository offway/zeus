...
public class GoodsController {
	...
	public JsonResult screening(@RequestBody @ApiParam("筛选条件") GoodsScreeningDto goodsScreeningDto) {
		if ((goodsScreeningDto.getSort() == 0 && goodsScreeningDto.getPickId() != null) && goodsScreeningDto.getSort() == 0) {
			return jsonResultHelper.buildSuccessJsonResult(phGoodsService.limtbypick(goodsScreeningDto.getPickId(), (goodsScreeningDto.getPage() * goodsScreeningDto.getSize()), goodsScreeningDto.getSize()));
		} else {
